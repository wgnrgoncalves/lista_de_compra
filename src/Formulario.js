...
class Formulario extends Component{
    ...
    render(){
        return(
            <div>
                Nome: <input ref={this.nome} type="text" value={this.props.nome} onChange={this.atualiza}></input><br/>
                Preco: <input ref={this.preco} type="text" value={this.props.preco} onChange={this.atualiza}></input><br/>
                Quantidade: <input ref={this.quantidade} type="text" value={this.props.quantidade} onChange={this.atualiza}></input><br/>
                <input type="button" value="Adicionar" onClick={this.adicionar}></input>
            </div>
        )
    }
